...
- [kuehle-orte-methodik.md](./kuehle-orte-methodik.md) — Kühle Orte (OSM ODbL 1.0 + redaktionelle Anreicherung, Kühle-Score, AC-Ehrlichkeit, Caveats), siehe ADR-020. Landing-Route `/hitze` (Kühle-Orte-Landing + Geolocation), Layer `kuehle-orte`.
