...
Auto-generiert via `pnpm doc:pipelines` aus `scripts/lib/sources.ts`. Stand: 2026-07-01.

**51 Layer total**, gruppiert nach Bundle.

## Pro-Bundle-Übersicht
### A: Boundaries

| Slug | Kind | Source | Lizenz | Stand | Build-Schritt |
|---|---|---|---|---|---|
...
| `kuehle-orte` | local | www.openstreetmap.org/copyright | ODbL 1.0 | — | `scripts/build-kuehle-orte.ts` |
